...
export class BoredApesContract extends ethereum.SmartContract {
  static bind(address: Address): BoredApesContract {
    return new BoredApesContract("BoredApesContract", address);
  }
